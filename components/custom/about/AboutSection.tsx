...
export default function AboutSection() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      ctx = gsap.context(() => {
        gsap.from(".about__content", { x: -60, opacity: 0, duration: 0.9, ease: "power3.out", scrollTrigger: { trigger: sectionRef.current, start: "top 82%", once: true } });
        gsap.from(".about__media", { x: 60, opacity: 0, duration: 0.9, ease: "power3.out", scrollTrigger: { trigger: sectionRef.current, start: "top 82%", once: true } });
      });
    })();
      ...
      <div className="about__container">
        <div className="about__content">
          ...
          <p className="about__text">
            A&amp;E NYC Plumbing is a fully licensed and insured plumbing contractor serving
            Manhattan and all five NYC boroughs. From emergency drain repairs to full water
            heater installations, we handle it all with speed, professionalism, and upfront pricing.
          </p>
          <p className="about__text">
            We&apos;re available Monday through Sunday, 9am to 9pm — because plumbing
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              ...
              alt="A&E NYC Plumbing licensed plumbers"
              width={690}
              height={613}
            ...
            <div className="about__exp-box w-full! md:w-fit! flex! flex-row! gap-10!">
              <div className="about__exp-icon">
                <Image src="/images/vector-decoration.svg" alt="Plumbing Icon" width={40} height={40} />
              </div>
              <div className="about__exp-content flex flex-row gap-4">
                <span className="about__exp-number">5</span>
                <span className="about__exp-text">NYC Boroughs<br />Covered</span>
              </div>
            </div>
          </div>
        </div>
