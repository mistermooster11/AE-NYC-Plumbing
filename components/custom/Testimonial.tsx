  ...
  return (
    <button
      ...
      style={{
        ...
        border: "1px solid rgba(80,182,234,0.35)",
        borderRadius: "50%",
        width: "4.4rem",
        height: "4.4rem",
        display: "flex",
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLButtonElement).style.borderColor = "#50B6EA";
        (e.currentTarget as HTMLButtonElement).style.color = "#fff";
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLButtonElement).style.borderColor =
          "rgba(80,182,234,0.35)";
        (e.currentTarget as HTMLButtonElement).style.color = "#50B6EA";
      }}
    >
      {dir === "prev" ? (
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  cursor: "pointer",
                  background: i === active ? "#50B6EA" : "rgba(80,182,234,0.3)",
