        ...
        <div className="bg-[#50B6EA] border-b border-[rgba(2,73,121,.2)] w-full">
            <div className="inner inner-header flex flex-row items-center justify-between min-h-[4.4rem] p-0">
                ...
                <Link href="/" className="block lg:hidden float-left" aria-label="A&E NYC Plumbing">
                    {/* [TODO: Replace with A&E NYC Plumbing logo SVG] */}
                ...
                <div className="hidden lg:flex flex-1 justify-center">
                    <a
                        href="tel:6463927164"
                        className="flex items-center gap-2 text-brand-navy text-[1.4rem] font-light tracking-[.05rem] py-[2rem] no-underline transition-colors duration-[350ms] hover:text-[#013560]"
                    >
                        <Phone size={14} strokeWidth={2} />
                        <span>(646) 392-7164 — Licensed NYC Plumbers, Mon–Sun 9am–9pm</span>
                    </a>
                </div>
